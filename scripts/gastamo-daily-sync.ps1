...
$startUtc     = [Uri]::EscapeDataString("$(Get-Date -Format 'yyyy-MM-dd' -Date (Get-Date).AddDays(-1))T07:00:00.000+0000")
$endUtc       = [Uri]::EscapeDataString("$(Get-Date -Format 'yyyy-MM-dd' -Date (Get-Date).AddDays(0))T07:00:00.000+0000")
